      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-2xl font-bold">£26/month</p>
            <p className="text-lg text-[#003B44]">Website Development: £998</p>
          </div>
        </div>
        <div
          className={`p-6 rounded-lg border-2 cursor-pointer transition-all ${
        ...
        >
          ...
          <div className="space-y-2">
            <p className="text-2xl font-bold">£299/year</p>
            <p className="text-lg text-[#003B44]">Website Development: £820</p>
